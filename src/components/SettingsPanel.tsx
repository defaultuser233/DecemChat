    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-80 glass-effect z-50 animate-slide-in-right shadow-2xl">
        ...
        <div className="p-4 space-y-6 overflow-y-auto h-[calc(100%-70px)] custom-scrollbar">
          ...
          <div className="space-y-3">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {supportsVision(model.id) && (
                            <span className="flex items-center gap-0.5 text-[#95E1D3]">
                              ...
                              <span className="text-[10px]">视觉理解</span>
                            </span>
                          )}
                        </span>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-2">
              ...
              {supportsVision(settings.model) && (
                <span className="flex items-center gap-0.5 px-1.5 py-0.5 rounded-full bg-[#95E1D3]/20 text-[#4DB6AC]">
                  <Eye className="w-3 h-3" />
                  <span className="font-medium">视觉理解</span>
                </span>
              )}
            </p>
          </div>
          ...
          {/* Footer — Ave atque vale 呼吸灯艺术字 */}
          <div className="pt-6 mt-4 border-t border-border">
            <p className="text-center font-['Poppins'] text-lg tracking-[0.12em] animate-breathe-glow">
              Ave atque vale
            </p>
          </div>
        </div>
